...
internal class StrongTypedDecimalSerializerFactory : ILiteDBSerializerFactory
{
	public bool CanSerialize(Type type)
	{
		...
		return genericArguments[0] == type && genericArguments[1] == typeof(decimal);
	}

	public ILiteDBSerializer CreateSerializer(Type type)
	{
		var strongTypeSerializerType = typeof(StrongTypedDecimalSerializer<>).MakeGenericType(type);
