...
///     Add it to your DbContext class in protected override void ConfigureConventions(ModelConfigurationBuilder
///     configurationBuilder) like this:
	...
	where TPrimitiveValue : IComparable, IComparable<TPrimitiveValue>, IEquatable<TPrimitiveValue>
{
	public StrongTypedValueValueConverter()
		: base(id => id.PrimitiveValue, primitiveId => StrongTypedExtensions.Create<TStrongTypedValue, TPrimitiveValue>(primitiveId))
	{
	}
}