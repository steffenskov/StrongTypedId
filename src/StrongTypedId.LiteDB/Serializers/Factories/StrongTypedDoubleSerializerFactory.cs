...
internal class StrongTypedDoubleSerializerFactory : ILiteDBSerializerFactory
{
	public bool CanSerialize(Type type)
	{
		...
		return genericArguments[0] == type && genericArguments[1] == typeof(double);
	}

	public ILiteDBSerializer CreateSerializer(Type type)
	{
		var strongTypeSerializerType = typeof(StrongTypedDoubleSerializer<>).MakeGenericType(type);
